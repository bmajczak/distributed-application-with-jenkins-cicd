...
username=$(python -c "import urllib.parse;print( urllib.parse.quote('admin_vp', safe='') )")
new_password=$(python -c "import urllib.parse;print( urllib.parse.quote('admin_vp', safe='') )")
fullname=$(python -c "import urllib.parse;print( urllib.parse.quote('admin_vp', safe='') )")
email=$(python -c "import urllib.parse;print( urllib.parse.quote('admin_vp@test.com', safe='') )")
